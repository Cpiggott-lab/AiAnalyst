...
export default function LandingPage() {
  return (
    <div className="flex flex-col items-center text-center">
      <div className="relative w-screen h-[70vh] mb-16 rounded-none overflow-hidden shadow-md">
        <img
          src={AiAnalystImage}
      ...
      <div className="flex flex-col items-center w-full px-4 space-y-16 pb-20">
        <section className="bg-white rounded-lg shadow-md p-6 w-full max-w-screen-xl">
